...
//    }
//
    //  securityFilterChain 을 만들면 내가 다 만들어야 한다.
    @Bean
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                .csrf(csrf -> csrf.disable())   // CSRF 비활성화(CORS 를 이용한 공격방식)
                /**********************************************
...
//                        .logoutSuccessUrl("/user/login?logout") // 로그아웃 성공후 ridirect url
                ...
                .oauth2Login(httpSecurityOAuth2LoginConfigurer -> httpSecurityOAuth2LoginConfigurer
                        ...
                        //  code 롤 받아오는것이 아니라, AccessToken 과 사용자 profile 정보를 받아오게 된다.
