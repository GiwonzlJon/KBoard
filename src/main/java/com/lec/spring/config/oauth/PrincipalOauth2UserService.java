...
public class PrincipalOauth2UserService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        System.out.println("""
                ...
                , oAuth2User.getAttributes())  //  Map<String, Object>  사용자 프로필 정보가 담겨있다.
        );
//  후처리 : 회원가입 진행
        String provider = userRequest.getClientRegistration().getRegistrationId();  //  "google", "facebok", ...
...
// username은 중복되지 않도록 만들어야 한다
        ...
        principalDetails.setUserService(userService);  // 잊지말자 잊지 않겠읍니다.
