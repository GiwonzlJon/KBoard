...
// String -> View 이름 -> View resolver



@RestController  //  데이터를 response 하기 위함.  내부적으로 @controller + @ResponseBody
public class AttachmentController {
    ...
    public ResponseEntity<Object> download(Long id){
        ...
        try {
            ...
            headers.setContentDisposition(ContentDisposition.builder("attachment").filename(URLEncoder.encode(sourceName, "utf-8")).build());  //  URLEncoder.encode 해야 한글파일도 가능하다
